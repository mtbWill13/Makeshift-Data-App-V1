...
window.addEventListener("load", () => {
	...
	if (url.searchParams.get("teamA") && url.searchParams.get("teamB")) {
		teamAInput.value = url.searchParams.get("teamA");
		teamBInput.value = url.searchParams.get("teamB");
	}
});
